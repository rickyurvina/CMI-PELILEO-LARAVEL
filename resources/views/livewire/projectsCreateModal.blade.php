...
{{--<div class="modal fade default-example-modal-right-lg project-modal-right" data-toggle="projectModal"--}}
...
{{--                    <x-form.inputs.text type="datetime-local" id="start_date" label="{{ trans('general.start_date') }}" class="col-md-6 col-sm-12 required" model="start_date"/>--}}
{{--                    <x-form.inputs.text type="datetime-local" id="end_date" label="{{ trans('general.end_date') }}" class="col-md-6 col-sm-12 required" model="end_date"/>--}}
{{--                    <div class="form-group col-md-6 col-sm-12 required">--}}
